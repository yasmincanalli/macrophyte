...
#Loading data
setwd("E:/analises/doutorado") #search the directory
dir()
...
par(mar=c(5,5,5,5))
par(cex=1.3)
plot_sumz(resprof,cex.axis=2, cex.lab=2.5) #Use sumz1=FALSE or sumz2=FALSE, for exclude positive or negative response
par(cex=1.5)
...
par(mar=c(5,5,5,5))
par(cex=1.3)
plot_sumz(restr,cex.axis=2, cex.lab=2.5) #Use sumz1=FALSE or sumz2=FALSE, for exclude positive or negative response
par(cex=1.5)
plot_taxa(restr) #Use z1=FALSE or 2=FALSE, for exclude positive or negative response
restr$sppmax
restr$sumz.cp
